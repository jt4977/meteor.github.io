Proposal
================
Anqi Li, Chuyuan Xu, Jingtong He, Kaicheng Mo, Xiwei Fu
2025-11-05
...
quality summary.  
**Modeling and Forecasting Results** including unsupervised climate
clustering and statewide predictive models for daily maximum temperature
(seasonal ARIMAX with Fourier terms and XGBoost), together with model
comparison.  
...
**: Time-Series and Predictive Modeling: ** Use daily statewide-averaged
meteorological series to fit seasonal ARIMAX models with Fourier terms
and XGBoost models for forecasting maximum temperature. Compare their
performance using a common train–test split, residual diagnostics, and
accuracy metrics, and discuss trade-offs between interpretability and
...
**Unsupervised Climate Clustering and PCA:** Use k-means clustering to
identify distinct county-level climate types, selecting k=2 via elbow
and silhouette diagnostics. Apply PCA to visualize cluster separation in
a low-dimensional space and combine boxplots and county maps to
summarize and interpret the resulting climate regimes.
...
identifiers. Implementing time-series models (ARIMAX + Fourier) and
XGBoost efficiently in R and ensuring reproducibility through clear,
...
**Nov 16–23:** Explore spatial and temporal climate patterns through
descriptive statistics and visualizations.  
**Nov 24–Nov 30:** Fit regression and mixed-effects models to identify
key climatic associations.  
**Dec 1–6:** Summarize findings, visualize results, and compile the
...
plots and maps.  
**Statistical and Predictive Modeling: ** Apply k-means clustering and
PCA to define county-level climate regimes, and fit statewide ARIMAX +
Fourier and XGBoost models to forecast daily maximum temperature.  
