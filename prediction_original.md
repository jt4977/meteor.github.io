...
Overall fit statistics for the ARIMAX + Fourier model
...
Coefficient estimates for ARIMAX + Fourier model
...
pattern.
![](prediction_original_files/figure-gfm/ljung-table-1.png)<!-- -->

| Statistic | Degrees.of.freedom | P.value | Model.df | Total.lags.used |
|----------:|-------------------:|--------:|---------:|----------------:|
|     330.1 |                362 |  0.8844 |        3 |             365 |

Ljung–Box Test for ARIMAX + Fourier Residuals
...
![](prediction_original_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](prediction_original_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](prediction_original_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
Performance comparison of ARIMAX + Fourier vs XGBoost on the same test
dates

The test-set results show that XGBoost substantially outperforms the
ARIMAX + Fourier model across all metrics, with far lower RMSE, MAE, and
MAPE, as well as a much higher R². These differences are consistent with
the theoretical design of the two models. The ARIMAX + Fourier approach
relies on linear relationships, predefined seasonal components, and a
limited set of lagged regressors; as a result, it struggles to capture
nonlinear temperature dynamics and complex interactions among
