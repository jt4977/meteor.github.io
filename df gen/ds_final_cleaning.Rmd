...
```{r, eval = FALSE}
dsn_meteor = str_c(output, "/meteor_2016to20_NY state.csv")
...
```{r}
file_check = read_csv(
  '/Users/chuyuanxu/Desktop/Columbia/25_fall/BIST8105_DS I/final project/meteor_2016to20_NY state.csv', n_max = 20)
